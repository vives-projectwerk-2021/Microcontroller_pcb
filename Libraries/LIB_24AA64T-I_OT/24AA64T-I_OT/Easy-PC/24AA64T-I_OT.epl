...
(library Library_1
	...
	(compDef "24AA64T-I_OT" (originalName "24AA64T-I_OT") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "WP") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/DeviceDoc/21189R.pdf")
		(attr "Height" "1.45 mm")
	)
