...
//1630236/477504/2.49/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TCN75AVUA713-VAO" (originalName "TCN75AVUA713-VAO")
	...
	(compDef "TCN75AVUA713-VAO" (originalName "TCN75AVUA713-VAO") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TCN75AVUA713-VAO"))
		...
		(attr "Manufacturer_Part_Number" "TCN75AVUA713-VAO")
		(attr "Mouser Part Number" "579-TCN75AVUA713-VAO")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/TCN75AVUA713-VAO?qs=5aG0NVq1C4yOgnS8t5srmQ%3D%3D")
		(attr "Arrow Part Number" "TCN75AVUA713-VAO")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tcn75avua713-vao/microchip-technology")
		(attr "Description" "Board Mount Temperature Sensors Automotive, 2-Wire Serial Temp Sensor/Thermal Monitor")
		(attr "<Hyperlink>" "http://ww1.microchip.com/downloads/en/DeviceDoc/21935D.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "TCN75AVUA713-VAO.stp")
